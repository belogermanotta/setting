...
() {
  ...
  typeset -g POWERLEVEL9K_SHORTEN_STRATEGY=truncate_to_first
  ...
  # Disabled: project-root markers (.git, package.json, etc.) no longer exempt
  # a folder from shortening -- only the last POWERLEVEL9K_SHORTEN_DIR_LENGTH
  # segments stay full, unconditionally.
  ...
  # Set absurdly high so shortening is forced unconditionally (based on depth/anchors),
  # regardless of actual terminal width -- POWERLEVEL9K_DIR_MAX_LENGTH=0 alone only kicks
  # in when the terminal is narrow enough to need it.
