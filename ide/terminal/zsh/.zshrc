...
if type eza &>/dev/null; then
  ...
  echo ERROR: eza could not be found. Skip setting up eza aliases. run `brew install eza`
fi
...
__conda_setup="$('/Users/echandra-mac/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/echandra-mac/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/echandra-mac/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/echandra-mac/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
